              ...
              BlocBuilder<AddressCubitCubit, AddressCubitState>(
                builder: (context, state) {
                  if (state is LocalDataSuccess) {
                    // widget data ----------------------------------
                    //for mobile phone
                    var listViewForMobile = ListView.builder(
                        itemCount:
                    ...
                    //Form mobile phone
                    //  Form Tablet / mid screen
                    var listViewForTablet = ResponsiveBuilder(
                        builder: (context, sizingInformation) {
                      return GridView.builder(
                          itemCount: state.listData.isEmpty
                              ? 1
                    ...
                    return ResponsiveBuilder(
                      ...
                      if (sizingInformation.deviceScreenType ==
                        ...
                        return listViewForMobile;
                      } else {
                        return listViewForTablet;
                      }
                    });
                  } else {
                    return Center(
